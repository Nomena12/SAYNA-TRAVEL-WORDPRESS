...
<div class="lpc_layer_relay"
	...
	<div class="lpc_layer_relay_display_hours">
		<div class="lpc_layer_relay_hours_header">
			...
			<div class="lpc_layer_relay_hours_title"><?php echo __('Opening hours', 'wc_colissimo'); ?></div>
	...
	<div class="lpc_relay_choose_btn">
		<a class="lpc_show_relay_details"><?php echo __('Display on map', 'wc_colissimo'); ?></a>
