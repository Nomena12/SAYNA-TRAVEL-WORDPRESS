...
class chronopost_abstract_shipping extends abstract_shipping {
	...
	public function init_form_fields() {
		...
		if ( ! in_array( $this->id, [ 'chronopost_express', 'chronopost_classic', 'chronopost_relais', 'chronopost_precise', 'chronopost_relais_europe', 'chronopost_relais_dom', 'chronopost_2shop' ] ) ) {
	...
	private function get_quickcost( $package ) {
		...
		if ( $woocommerce_weight_unit == 'g' && ! empty( $cart_weight ) )
